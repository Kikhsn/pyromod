...
from ...core import should_patch, patch_into
...
class MessageHandler(pyrogram.handlers.message_handler.MessageHandler):
    ...
    async def check_if_has_matching_listener(self, client: Client, message: Message):
        ...
        patterns = (
            Identifier(reply_message_id=reply_to_id, chat_id=[chat_id, chat_username],
        ...
        for pat in patterns:
            ...
            if not listener:
                listener = client.get_listener_matching_with_data(pat, ListenerTypes.MIXED)
